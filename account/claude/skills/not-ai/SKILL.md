...
```bash
python3 "{{CLAUDE_HOME}}/tools/not-ai/gate.py" draft.txt --genre linkedin
python3 "{{CLAUDE_HOME}}/tools/not-ai/gate.py" draft.txt --genre student --json
```
...
```bash
python3 "{{CLAUDE_HOME}}/tools/not-ai/gate.py" draft.txt --genre technical --protect "API v2"
python3 "{{CLAUDE_HOME}}/tools/not-ai/gate.py" draft.txt --genre readme --ascii-punctuation
```
