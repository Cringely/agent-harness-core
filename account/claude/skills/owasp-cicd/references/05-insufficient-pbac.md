---
title: 'CICD-SEC-5: Insufficient PBAC'
description: OWASP CI/CD Top 10 reference for insufficient pipeline-based access controls including overprivileged execution nodes and shared environments
---
