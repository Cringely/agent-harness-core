...
description: OWASP CI/CD Top 10 reference for insecure system configuration vulnerabilities including unpatched CI/CD infrastructure and debug exposure
---
