...
Describe "Restore-ClaudeProject" {
    BeforeAll {
        ...
        # (`Get-ProjectSlug` among them) does the same lift for the same reason and records why
        # importing them from there instead (a move) was rejected rather than just not considered.
